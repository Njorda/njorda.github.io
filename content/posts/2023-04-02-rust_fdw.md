...
URL: "/2023/06/12/rust-foreign-data-wrappers-postgres-rust"
---
...
So to say it simple, a foreign data wrapper add functionality to access a external data source. This blog post will be based upon a implementation for CMU 15-721(not taking the course just doing it for fun), repo [here](https://github.com/Njorda/db721_fdw).
